    ...
    <>
      <div className="relative min-h-screen bg-bg-dark text-white flex flex-col justify-between overflow-x-hidden font-sans">
        ...
        <motion.header 
          ...
          className="fixed top-0 left-0 right-0 z-40 bg-bg-dark/70 backdrop-blur-md border-b border-white/5 py-4"
        >
        ...
        <main className="flex-1 max-w-5xl mx-auto px-6 md:px-12 pt-32 pb-24 w-full">
          ...
          >
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  <motion.span 
                    ...
                    className="text-xs font-semibold text-accent tracking-widest uppercase font-mono bg-accent/10 border border-accent/20 px-3 py-1 rounded-full inline-block"
                  >
                    {project.subtitle}
                  </motion.span>
            ...
            {/* Banner/Artwork with slide reveal */}
            <motion.div 
              variants={itemVariants}
              className="relative h-64 sm:h-96 w-full rounded-3xl overflow-hidden bg-gradient-to-br from-primary/30 via-secondary/20 to-accent/30 border border-white/5 flex items-center justify-center shadow-2xl"
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              >
                ...
                <div className="pt-6">
                  <Link
                    href="/"
                    className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 border border-white/10 hover:border-primary/50 text-white font-medium text-sm transition-all duration-300 hover:scale-[1.02]"
                  >
              ...
              >
                {/* Meta details card */}
                <div className="p-6 rounded-2xl bg-card-dark border border-card-border space-y-6 shadow-xl">
                ...
                <div className="p-6 rounded-2xl bg-card-dark border border-card-border space-y-4 shadow-xl animate-pulse-slow">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, idx) => (
                      <motion.span
                        ...
                        className="text-xs font-mono text-gray-300 bg-white/5 border border-white/5 px-2.5 py-1.5 rounded-md cursor-default inline-block"
                      >
                        {tech}
                      </motion.span>
                    ))}
